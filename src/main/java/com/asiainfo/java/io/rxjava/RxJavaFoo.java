package com.asiainfo.java.io.rxjava;
...
//        Observable.merge(task1, task2, task3).toBlocking().subscribe(new Subscriber<User>() {
//            @Override
//            public void onCompleted() {
...
//
//            @Override
//            public void onNext(User deviceInfo) {
////                System.out.println("deviceInfo:" + deviceInfo);
//            }
//        });

        System.out.println("end time:" + DateUtil.date());
...
//        }
    ...
    private static List<Observable<User>> observables() {

        User deviceInfo = new User();
        ...
        Observable<User> task1 = Observable.fromCallable(() -> {
            ...
            deviceInfo.setUsername("aa:bb:cc:dd:ee:ff");
            return deviceInfo;
...
//                devReq.setDevMac("");
//                List<TabDevBasicInfoModel> modelList = tabDeviceInfoMapper.queryDeviceInfoList(devReq);
