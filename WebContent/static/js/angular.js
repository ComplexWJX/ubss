 ...
 * @param  {String} name    the name to forkjoin
...
function Browser(window, document, $log, $sniffer) {
  ...
  self.notifyWhenNoOutstandingRequests = function(callback) {
    ...
    // at some deterministic time in respect to the forkjoin runner's actions. Leaving things up to the
   ...
   *
   * Unlike when calling `setTimeout` directly, in forkjoin this function is mocked and instead of using
      ...
      switch(nodeType) {
        ...
        case 8: /* Comment */
          try {
            ...
            // Just ignore it and continue. (Can't seem to reproduce in forkjoin case.)
          }
          break;
      }
...
// while evaluating the expression, which is a stronger but more expensive forkjoin. Since reflective
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     * ```html
     * <file src="./forkjoin/ng/rootScopeSpec.js" tag="docs1" />
     * ```
     *
     * # Inheritance
